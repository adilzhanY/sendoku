...
#
# None of them has a kana, a kanji, a Chinese character, a Hangul syllable, an Arabic letter, a
# Devanagari one, a Bengali one or a Thai one in it, and none of them is going to. A Chinese face alone is tens of thousands of glyphs
